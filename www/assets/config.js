...
window.SYG = {
  ...
  WYNAJEM_PAKIETY: [
    ...
    { id: 'kom-mid', ev: 'komunijny', evNazwa: 'Komunia / chrzest', nazwa: 'Komunijny MID', opis: 'najczęściej wybierany', cena: 349, cenaTxt: 'od 349 zł / doba',
      pozycje: 'Wszystko z ESENCJI + szyld powitalny, plan stołów, numery stolików ×10, lampki 10 m + lampiony ×6, krzyżówka z imionami' },
    ...
    { id: 'wes-mid', ev: 'weselny', evNazwa: 'Wesele', nazwa: 'Weselny MID', opis: 'do 120 gości', cena: 499, cenaTxt: 'od 499 zł / doba',
      pozycje: 'Wszystko z ESENCJI + litery podświetlane MAŁE (inicjały), krzyżówka z imionami, skrzynka na życzenia, świeczniki ×12' },
    ...
    { id: 'jub-mid', ev: 'jubileuszowy', evNazwa: 'Jubileusz / urodziny', nazwa: 'Jubileuszowy MID', opis: 'okrągła rocznica', cena: 349, cenaTxt: 'od 349 zł / doba',
      pozycje: 'Wszystko z ESENCJI + litery podświetlane MAŁE 25 cm, krzyżówka z imionami, lampki 10 m + lampiony ×6' },
  ...
  PERSONALIZACJE: [
    ...
    { nazwa: 'Kafelki z imionami do krzyżówki', opis: 'Imiona gości lub pary — komplet', cena: 35, foto: 'pers-kafelki-krzyzowka.jpg' },
